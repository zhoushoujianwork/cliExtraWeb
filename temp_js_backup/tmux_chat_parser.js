...
class TmuxChatParser {
    ...
    isThinkingLine(line) {
        const thinkingPatterns = [
            /Thinking\.{3,}/i,                  // Thinking... (完全匹配)
            /Thinking\.{1,}/i,                  // Thinking. (完全匹配)
            /正在思考\.{3,}/,                   // 正在思考... (完全匹配)
            /思考中\.{3,}/,                     // 思考中... (完全匹配)
            /Processing\.{3,}/i,                // Processing... (完全匹配)
            /Analyzing\.{3,}/i,                 // Analyzing... (完全匹配)
        ];
    ...
    isThinkingMessage(content) {
        const thinkingPatterns = [
            /Thinking\.{0,}/i,                  // Thinking... 或 Thinking (完全匹配)
            /正在思考\.{0,}/,                   // 正在思考... (完全匹配)
            /思考中\.{0,}/,                     // 思考中... (完全匹配)
            /Processing\.{0,}/i,                // Processing... (完全匹配)
            /Analyzing\.{0,}/i,                 // Analyzing... (完全匹配)
        ];
